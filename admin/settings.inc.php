...
/**
 * Carrega as configurações de layout
 */
//$bodyClass= NULL;
//$htmlClass= NULL;
//const LAYOUT_SETTINGS_FILE = __DIR__ . "/layout-settings.json";
//$content = uteis::getFileContent();
//
//if ( !empty($content) ) {
//    foreach($content as $key => $indice) {
//        if ($content[$key] && $key !== 'root-text-sm') {
//            $bodyClass .= " {$key}";
//        } else if ($key == 'root-text-sm' && !empty($content[$key])) {
//            $htmlClass = "{$key}";
//        }
//    }
//    DEFINE('HTML_SETTING', $htmlClass);
//    DEFINE('BODY_SETTINGS', $bodyClass);
//}
