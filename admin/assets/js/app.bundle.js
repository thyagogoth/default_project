...
var initApp = function (e) {
    return e.listFilter = function (n, e, t) {
        ...
        initApp.playSound(admin+"/assets/media/sound", "messagebox"), $(".js-modal-settings").modal("hide"), "undefined" != typeof bootbox ? bootbox.confirm({
        ...
        if (void 0 !== $.fn.dropdown ? Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1 : console.log("OOPS! bs.popover is not loaded"), $(document).on("click", ".dropdown-menu", function (e) {
            ...
            switch (!0) {
                ...
                case "lang" === t:
                    ...
                    }) : initApp.loadScript(admin+"/assets/js/i18n/i18n.js", function () {
                        $.i18n.init({
                            resGetPath: admin+"/assets/media/data/__lng__.json",
                            load: "unspecific",
                            fallbackLng: !1,
                            lng: p
                        }, function (e) {
...
//    , 
//    $.ajax({
//        url: admin + "/assets/audit/verify.txt",
//        type: "HEAD",
//        error:  () => {
//        },
//        success: function () {}
