...
class m2brimagem
{
    ...
    function __construct($origem = '', $extensoes_validas = array('jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png'))
    {
    ...
    private function criaImagem()
    {
        switch ($this->formato) {
            ...
            case 3:
                ...
                break;
            case 6:
                $this->img = createImageFromBmp($this->origem);
                $this->extensao = 'bmp';
                break;
            default:
        ...
        if ($imagem) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'gif':
                    ...
                    break;
                case 'bmp':
                    $marcadagua = createImageFromBmp($imagem);
                    break;
                default:
